...
# address types starter prefixes and keys for each type
PREFIXES = [
    "addr",
    "addr_test",
    "script",
...
"""
      ---- Network type for both tests and deployment ----

      for the main net any fees are charged in real currency/Token (PAYL/ADA)
"""
...
# hashing of the generated keys for address creation
class Hash(object):
    hex_repr = None
...
# address/node poointers on the block / PAYL pool 
...
# address validation as per the cardano network and PAYL pool specifications
